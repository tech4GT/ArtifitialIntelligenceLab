...
public class GSP {
    ...
    public void plan() {
        ...
        while (!st.empty()) {
                ...
                if (curr.hold[elements[2].charAt(0) - 97] == 1) {
                    ...
                    if (temp != -1) {
                        st.push("(unstack " + Character.toString((char) (temp + 97)) + " " + elements[2].charAt(0)
                                + ")");
                        st.push("(on " + Character.toString((char) (temp + 97)) + " " + elements[2].charAt(0)
                                + ")^(clear " + Character.toString((char) (temp + 97)) + ")^(AE)");
                    }
                }
            ...
            } else if (sub.contains("pick") || sub.contains("putdown") || sub.contains("stack")
                    || sub.contains("unstack")) {
