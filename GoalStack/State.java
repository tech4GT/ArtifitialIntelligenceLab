...
/*
 * sample input 4 (on b a)^(ontable a)^(ontable c)^(ontable d)^(AE) (on c a)^(on
 * b d)^(ontable a)^(ontable d) 4 (ontable a)^(ontable b)^(ontable c)^(ontable
 * d) (on a b)^(on b c)^(on c d) 3 (ontable a)^(ontable b)^(ontable c) (on a
 * b)^(on b c)
 */